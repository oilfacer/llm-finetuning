...
# Configuration
MODEL_PATH = "./grpo_musique_final"  # Path to trained GRPO model
DATASET_NAME = "your-hf-username/musique-processed"  # Your dataset
TEST_SPLIT = "test"  # Use "test" or "validation"
MAX_SEQ_LENGTH = 4096  # Match training context length
OUTPUT_DIR = "./evaluation_results_grpo_musique"
...
if __name__ == "__main__":
    ...
    with open(SAMPLE_PREDS_PATH, "w") as f:
        f.write(f"Musique GRPO Evaluation Results ({len(test_dataset)} samples)\n")
        f.write("=" * 80 + "\n\n")
