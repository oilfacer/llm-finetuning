...
# Configuration
MODEL_PATH = "./grpo_triviaqa_final"  # Path to trained GRPO model
...
OUTPUT_DIR = "./evaluation_results_grpo_triviaqa"
...
if __name__ == "__main__":
    ...
    with open(SAMPLE_PREDS_PATH, "w") as f:
        f.write(f"TriviaQA GRPO Evaluation Results ({len(test_dataset)} samples)\n")
        f.write("=" * 80 + "\n\n")
